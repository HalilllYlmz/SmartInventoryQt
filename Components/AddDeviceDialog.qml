    ...
    contentItem: ColumnLayout {
        ...
        GridLayout {
            ...
            TextField {
                id: nameField
                Layout.fillWidth: true
                Layout.preferredHeight: 48 // YÜKSEKLİK ARTTIRILDI
                placeholderText: "Örn: Motor Bloğu"
                font.pixelSize: 15
                verticalAlignment: TextInput.AlignVCenter // Yazıyı ortala
                leftPadding: 12
                background: Rectangle {
                    color: parent.activeFocus ? "white" : "#f1f2f6"
                    radius: 12
            ...
            Rectangle {
                ...
                color: "#f1f2f6"
                radius: 12
                border.color: calendarPopup.opened ? "#3498db" : "transparent"
                border.width: 2
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        if (spaceBelow < 330) {
                            calendarPopup.y = -calendarPopup.height - 5
                        } else {
                            calendarPopup.y = dateInputArea.height + 5
                        }
                ...
                Popup {
                    ...
                    background: Rectangle {
                        ...
                        border.color: "#dfe6e9"
                        layer.enabled: true
                        layer.effect: MultiEffect { shadowEnabled: true; shadowOpacity: 0.15; shadowBlur: 10 }
                    }
                        ...
                        MonthGrid {
                            ...
                            delegate: Rectangle {
                                ...
                                Rectangle {
                                    ...
                                    color: isSelected ? "#3498db" : (isToday ? "#dfe6e9" : "transparent")
                                }

                                Text {
                                    anchors.centerIn: parent
                                    text: model.day
                                    color: isSelected ? "white" : (isCurrentMonth ? "#2d3436" : "#b2bec3")
                                ...
                                MouseArea {
                                    anchors.fill: parent
                                    onClicked: {
                                        if (model.month === calendarGrid.month) {
                                            rootDialog.selectedDate = model.date
                                            rootDialog.updateDateText()
                                            calendarPopup.close()
                                        }
                                    }
                                }
        ...
        RowLayout {
            ...
            Button {
                ...
                background: Rectangle {
                    ...
                    radius: 12
                    layer.enabled: true
                    layer.effect: MultiEffect { shadowEnabled: true; shadowOpacity: 0.3; shadowVerticalOffset: 2 }
                }
                onClicked: {
                    if (nameField.text === "" || serialField.text === "") {
                        console.warn("Alanlar boş!")
                        return
                    }
                    ...
                    Api.addDevice(newDevice, function(success) {
                        console.log("API yanıt döndü. Başarı durumu:", success)
                        if (success) {
