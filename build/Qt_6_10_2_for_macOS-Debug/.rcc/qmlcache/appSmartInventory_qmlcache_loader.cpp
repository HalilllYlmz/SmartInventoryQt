...
namespace _qt_qml_SmartInventory_Main_qml { 
...
namespace _qt_qml_SmartInventory_Components_DeviceListItem_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appSmartInventory)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appSmartInventory))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appSmartInventory)() {
    return 1;
}
